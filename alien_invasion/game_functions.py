"""
Game functions stores core functions of the program to simplify main file.
"""
...
def fire_bullet(ai_settings, screen, ship, bullets):
    ...
    # Create a new bullet and add in to the bullet group
...
def check_high_score(stats, sb):
    """Check to see in there's a new hogh score."""
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship,
    ...
    # True arguments state that object needs to disappear after collision
    # To let the bullet fly and kill more enemies set the first value to False
    if collisions:
...
def create_fleet(ai_settings, screen, ship, aliens):
    ...
    # Create an alien and find the number of aliens in one row
    alien = Alien(ai_settings, screen)
...
def check_fleet_edges(ai_settings, aliens):
    """Respond appropriately if any alien reaches the edges."""
